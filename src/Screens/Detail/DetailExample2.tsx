...
export default function DetailExample() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        <Image
          source={require('../../../assets/images/pelabuhan.jpg')}
        ...
        <View style={styles.headerText}>
          ...
          <Text style={styles.subtitle}>
            From crystal-clear waters to breathtaking sunsets, Pelabuhan Ratu is calling! Explore hidden islands, swim with manta rays, and create memories that last a lifetime.
          </Text>
        </View>
      </View>
        ...
        <View style={styles.contentCard}>
          ...
          <View style={styles.reviewCard}>
            <View style={styles.reviewHeader}>
              ...
              />
              <View>
                <Text style={styles.reviewerName}>By Chairil Skena</Text>
